...
Set your token as an environment variable POLYGON_TOKEN by adding this line in your .Renviron file:
```{r, eval=FALSE}
POLYGON_TOKEN = "<your-polygon-token-here>" 
```
If you don't have an API key already, you can get one from [Polygon](https://polygon.io).
